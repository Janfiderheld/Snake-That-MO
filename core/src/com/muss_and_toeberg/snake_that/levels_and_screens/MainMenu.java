...
public class MainMenu implements Screen {
    ...
    public MainMenu (final MainGame game){
        ...
        menuTable.add(btnStartGame).width(buttonWidth);             // Row 0, column 0
        menuTable.add(btnHighscore).width(buttonWidth);             // Row 0, column 1
        menuTable.add(btnStatistics).width(buttonWidth);            // Row 0, column 2
        menuTable.add(btnSettings).width(buttonWidth);              // Row 0, column 3
        menuTable.add(btnQuitGame).width(buttonWidth);              // Row 0, column 4
    ...
    public void render(float delta) {
        ...
        game.fontHUD.draw(game.batch, MainGame.myLangBundle.get("mainMenuHeader"), 200, 800);
        game.batch.end();
        stage.draw();
        game.camera.update();
    }
